...
playBtn.addEventListener('click', ()=>{
    ...
    humanScore = Math.floor(Math.random()*((humanDices.length - 1) - 0) + 0);
    computerScore = Math.floor(Math.random()*((computerDices.length - 1) - 0) + 0);
...
// Aggiungi colori diversi se vince l'uno o l'altro